...
if exist %pluginFolder%\EzChestUI.jar (
    del %pluginFolder%\EzChestUI.jar
)

if exist %pluginFolder%\EzChestUI\ (
    rmdir /Q /S %pluginFolder%\EzChestUI
)
...
echo Moving jar
xcopy /S /Q /Y /F build\libs\EzChestUI.jar %pluginFolder%\EzChestUI.jar* >> nul
echo Done!
goto :EOF
